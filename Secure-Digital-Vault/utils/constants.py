...
ICON_8 = f'{ASSETS_DIR}\\icon8.png'
ICON_9 = f'{ASSETS_DIR}\\icon9.png'
ICON_10 = f'{ASSETS_DIR}\\icon10.png'
ICON_11 = f'{ASSETS_DIR}\\icon11.png'
ICON_12 = f'{ASSETS_DIR}\\icon12.png'
ICON_13 = f'{ASSETS_DIR}\\icon13.png'
ICON_14 = f'{ASSETS_DIR}\\icon14.png'
ICON_15 = f'{ASSETS_DIR}\\icon15.png'
ICON_16 = f'{ASSETS_DIR}\\icon16.png'
ICON_17 = f'{ASSETS_DIR}\\icon17.png'